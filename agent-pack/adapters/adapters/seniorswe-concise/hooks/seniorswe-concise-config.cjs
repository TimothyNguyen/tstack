...
function getConfigDir() {
  return resolveDeclaredDir('SENIORSWE_CONCISE_CONFIG_DIR', path.join('.agent-pack', 'seniorswe-concise'));
}
...
function getStateDir() {
  ...
  return resolveDeclaredDir('SENIORSWE_CONCISE_STATE_DIR', path.join('.agent-pack', 'state', 'seniorswe-concise'));
}
