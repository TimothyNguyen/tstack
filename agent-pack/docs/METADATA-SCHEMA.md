...
metadata:
  ...
  dependencies:
    ...
    min-agent-arch-version: "0.1.4" # Minimum version of agent-pack required
...
dependencies:
  ...
  skills:                            # Other skills this depends on
    - diagram-export
    - diagram-validate
  min-agent-arch-version: "0.1.4"    # Earliest compatible agent-pack
...
**Backwards compatible** — works with existing agent-pack.
...
### agent-pack Version Compatibility

Skills declare minimum and maximum agent-pack versions.
