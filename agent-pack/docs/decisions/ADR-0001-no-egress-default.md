...
Agent packs run inside enterprise networks where outbound traffic to public
services is either monitored or blocked. An agent pack that phones home on first use
...
Prior art (upstream agent-pack) included public Supabase telemetry, GitHub update checks,
