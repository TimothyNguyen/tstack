# Agent Pack Adoption Guide

How to adopt and scale agent-pack across your organization.
...
3. **Run a Workflow**
   - Pick a workflow from [WORKFLOWS.md](../../docs/WORKFLOWS.md)
...
**Q: Can we use agent-pack offline?**
A: Yes. It ships with all 114 skills. MCPs (Postgres, GitHub) are optional.

**Q: How do we upgrade?**
A: Run `/agent-pack-upgrade` with an approved source path, pinned artifact, or internal mirror. No public update check runs by default.

**Q: What about cross-team coordination?**
A: Use `/orchestrate` agent to coordinate (brainstorm + parallel skill execution). See [WORKFLOWS.md](../../docs/WORKFLOWS.md).
...
1. **Start here:** [INSTALLATION.md](../../docs/INSTALLATION.md) (detailed setup)
...
4. **Reference:** [WORKFLOWS.md](../../docs/WORKFLOWS.md) (end-to-end examples)
