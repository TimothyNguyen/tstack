...
This plan defines how `agent-pack/` should deploy subagents for daily
...
2. Create `.agent-pack/subagents/<id>/manifest.json`.
3. Create `.agent-pack/subagents/<id>/result.json`.
...
```text
.agent-pack/subagents/<agent-id>/manifest.json
.agent-pack/subagents/<agent-id>/allocation.json
.agent-pack/subagents/<agent-id>/worktree/
.agent-pack/subagents/<agent-id>/patch.diff
.agent-pack/subagents/<agent-id>/rejection.json
.agent-pack/subagents/deployment.json
```
