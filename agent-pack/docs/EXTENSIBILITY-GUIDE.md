...
How to add new agents, skills, workflows, and training data to agent-pack without tribal knowledge.

## Overview

agent-pack is designed for principal engineers to extend systematically. This guide walks through adding a new **skill family** (set of related skills + coordination agent) end-to-end.
...
- [ ] `plugins/agent-pack/skills/migration-*/*.md` (host distros)
