...
version: 0.1.1
description: |
  Enterprise-safe software engineering agent pack. Routes work to scoped skills for
...
- Upgrade this agent pack: invoke `agent-pack-upgrade`.
...
- Agent-pack pattern reference: invoke `reference-agent-pack-patterns`.
