# Agent Pack Development Workflow

Complete workflow guide for adding, editing, and maintaining skills, MCPs, and agents in agent-pack.
...
```bash
npm install agent-pack

# This should:
# 1. Copy all SKILL.md files to ~/.agent-pack/skills/
