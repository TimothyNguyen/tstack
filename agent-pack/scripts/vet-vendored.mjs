#!/usr/bin/env node
/**
 * Scans vendored third-party agent packs for forbidden strings that would
...
const FORBIDDEN = [
  ...
  { pattern: /agent-pack-update-check\b/i, label: 'public update check' },
...
console.error(`vet:vendored: ${findings.length} finding(s) in vendored agent packs:\n`);
