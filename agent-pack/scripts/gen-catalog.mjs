...
const EXCLUDED_SKILLS = new Set(['agent-pack-upgrade']);
...
function generateCatalog(skills) {
  ...
  const lines = [
    '# Skill Catalog',
    '',
    `agent-pack catalogs ${skills.length} reusable skills. Agents, workflows, stacks, domains, adapters, and tool providers live in sibling package directories.`,
    '',
