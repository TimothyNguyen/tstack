---
name: reference-agent-pack-patterns
version: 0.1.0
description: |
  Quick reference for the agent-pack repo conventions. Covers
...
skills/<name>/SKILL.md.tmpl          # reusable skills
adapters/<name>/                     # framework adapters (ag-ui, langgraph, …)
stacks/<name>/                       # stack profiles (aws, databricks, …)
plugins/agent-pack/skills/   # committed mirror of all generated SKILL.md files
```
...
`plugins/agent-pack/skills/` contains committed copies of every
