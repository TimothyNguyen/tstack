...
Working code patterns for analyzing MLflow traces across Agent Packs.
...
def analyze_span_hierarchy(trace: Trace) -> Dict[str, Any]:
    ...
    Works for any Agent Pack (DSPy, LangGraph, etc.)
    """
...
Auto-detect Agent Pack from trace structure.
...
def detect_architecture(trace: Trace) -> Dict[str, Any]:
    """Detect Agent Pack from trace patterns.
