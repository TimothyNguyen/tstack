"""Integration tests for incremental codebase-engine extract behavior."""
...
def test_manifest_written_after_extract(tmp_path):
    ...
    manifest = docs / "codebase-out" / "manifest.json"
...
def test_extract_no_cluster_incremental_noop_preserves_existing_graph(tmp_path):
    ...
    graph_path = project / "codebase-out" / "graph.json"
