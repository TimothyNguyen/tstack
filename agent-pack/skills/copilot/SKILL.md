...
version: 0.1.1
description: |
  GitHub Copilot host adapter. Covers how to install this agent pack into a
...
Use this adapter when this agent pack runs inside GitHub Copilot (VS Code,
...
```
.agent-pack/generated/copilot/copilot-instructions.md
```

Install by copying (or symlinking) it to the repo's Copilot instructions file:

```bash
cp .agent-pack/generated/copilot/copilot-instructions.md \
