...
from codebase_engine.security import sanitize_label, check_graph_file_size_cap
...
def _build_server(graph_path: str):
    ...
    def _tool_god_nodes(arguments: dict) -> str:
        from codebase_engine.analyze import god_nodes as _god_nodes
    ...
    def _tool_list_prs(arguments: dict) -> str:
        # PR integration removed (enterprise policy: no external GitHub API egress).
        return "Error: PR listing not available in enterprise build."

    def _tool_get_pr_impact(arguments: dict) -> str:
        # PR integration removed (enterprise policy: no external GitHub API egress).
        return "Error: PR impact not available in enterprise build."

    def _tool_triage_prs(arguments: dict) -> str:
        # PR integration removed (enterprise policy: no external GitHub API egress).
        return "Error: PR triage not available in enterprise build."
