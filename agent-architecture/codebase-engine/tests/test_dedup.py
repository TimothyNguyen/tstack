"""Tests for codebase-engine/dedup.py entity deduplication pipeline."""
from __future__ import annotations
import pytest
from codebase_engine.dedup import deduplicate_entities, _entropy, _shingles
...
def test_build_calls_dedup():
    ...
    from codebase_engine.build import build
    chunk1 = {
...
def test_dedup_still_merges_real_typos():
    ...
    from codebase_engine.dedup import _is_variant_pair, _short_label_blocked
...
def test_variant_pair_helper():
    ...
    from codebase_engine.dedup import _is_variant_pair
...
def test_prefix_extension_symbols_not_merged():
    ...
    from codebase_engine.dedup import deduplicate_entities
...
def test_prefix_guard_does_not_block_same_length_typos():
    ...
    from codebase_engine.dedup import _norm
...
def test_numeric_tokens_differ_helper():
    ...
    multisets (#1284)."""
    from codebase_engine.dedup import _numeric_tokens_differ
