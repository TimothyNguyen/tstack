...
import codebase_engine.google_workspace as gw
...
def test_google_workspace_enabled_env(monkeypatch):
    monkeypatch.setenv("CODEBASE_ENGINE_GOOGLE_WORKSPACE", "yes")
    assert gw.google_workspace_enabled()

    monkeypatch.setenv("CODEBASE_ENGINE_GOOGLE_WORKSPACE", "0")
