...
Friction this guards: `uv tool install codebase-engine` puts codebase-engine in an isolated
...
from codebase_engine.llm import _backend_pkg_hint
...
def test_backend_pkg_hint_points_at_uv_tool_and_extra():
    ...
    assert 'codebase-engine[anthropic]' in msg
