...
from codebase_engine.extract import extract_python, extract, collect_files, _make_id, extract_bash, extract_json, _DISPATCH
...
def test_collect_files_from_dir():
    from codebase_engine.extract import _DISPATCH
...
def test_extract_generic_surfaces_tree_sitter_version_mismatch_hint(monkeypatch):
    ...
    import sys
    import types
    from codebase_engine.extract import _extract_generic, LanguageConfig
...
def test_extract_js_destructured_require_imports_from():
    ...
    from codebase_engine.extract import extract_js
...
def test_extract_js_destructured_require_named_symbols():
    ...
    from codebase_engine.extract import extract_js, _make_id, _file_stem
    result = extract_js(FIXTURES / "cjs_require.js")
...
def test_extract_tsx_uses_tsx_grammar():
    ...
    from codebase_engine.extract import _TSX_CONFIG, _TS_CONFIG
...
def test_extract_bash_via_dispatch():
    from codebase_engine.extract import _get_extractor
...
def test_semantic_reference_edges_carry_context_and_source():
    from codebase_engine.extract import _semantic_reference_edge
...
def test_dart_child_node_ids_are_stem_based(tmp_path):
    ...
    from codebase_engine.extract import extract_dart, _file_stem, _make_id
