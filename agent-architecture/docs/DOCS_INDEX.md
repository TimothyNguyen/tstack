...
- [skill-directory-contract.md](skill-directory-contract.md)
...
- [SKILL-VALIDATION-CHECKLIST.md](SKILL-VALIDATION-CHECKLIST.md)
...
- repo install path: [../../docs/INSTALLATION.md](../../docs/INSTALLATION.md)
