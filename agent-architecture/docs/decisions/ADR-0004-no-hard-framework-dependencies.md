...
Many agent skill packs couple themselves tightly to one host platform (LangChain,
...
The `agent-architecture` pack has **no hard runtime dependencies** on any agent
