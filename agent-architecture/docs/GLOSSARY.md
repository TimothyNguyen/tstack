...
Key terms and concepts used throughout agent-architecture.
...
**SKILL.md.tmpl**
Template file (source of truth). Contains: YAML frontmatter, {{PREAMBLE}} placeholder, skill documentation. Developers edit .tmpl files only.
