# Contributing Skills to Agent-Architecture

Guide for adding new skills, agents, and workflows to agent-architecture with full validation and testing.

## Overview

Agent-architecture is designed for **principal engineers** to extend systematically. New skills require:
