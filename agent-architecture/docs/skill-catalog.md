...
| `codebase-understander` | Enterprise-safe AST knowledge graph via `codebase-engine` — index, query, explain, path, affected. No external egress. | `codebase-understander/SKILL.md.tmpl` |
