...
Agent-architecture provides 73 reusable skills organized by category and specialized role.
...
- **[`architecture-agent-upgrade`](./skills/architecture-agent-upgrade/SKILL.md)** - Upgrades an installed architecture-agent skill pack through a policy-approved internal,
...
- **[`codex`](./skills/codex/SKILL.md)** - OpenAI Codex host adapter. Covers how to use this skill pack inside a
...
- **[`copilot`](./skills/copilot/SKILL.md)** - GitHub Copilot host adapter. Covers how to install this skill pack into a
...
- **[`reference-agent-architecture-patterns`](./skills/reference-agent-architecture-patterns/SKILL.md)** - Quick reference for the agent-architecture repo conventions. Covers *(swe, orchestrate)*
- **[`reference-skill-patterns`](./skills/reference-skill-patterns/SKILL.md)** - Repo-local quick reference for the skill-pack pattern this repo uses. *(swe, orchestrate)*
...
- **[`using-agent-skills`](./skills/using-agent-skills/SKILL.md)** - Use when starting any conversation - establishes how to find and use agent-architecture skills, *(swe, orchestrate)*
...
- [`reference-agent-architecture-patterns`](./skills/reference-agent-architecture-patterns/SKILL.md) - Quick reference for the agent-architecture repo conventions. Covers
- [`reference-skill-patterns`](./skills/reference-skill-patterns/SKILL.md) - Repo-local quick reference for the skill-pack pattern this repo uses.
...
- [`using-agent-skills`](./skills/using-agent-skills/SKILL.md) - Use when starting any conversation - establishes how to find and use agent-architecture skills,
