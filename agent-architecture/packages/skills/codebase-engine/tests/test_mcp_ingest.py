"""Tests for codebase-engine.mcp_ingest — MCP config file extraction."""
...
from codebase_engine.mcp_ingest import (
...
def test_dispatch_does_not_reroute_generic_json(tmp_path):
    from codebase_engine.extract import _get_extractor, extract_json
