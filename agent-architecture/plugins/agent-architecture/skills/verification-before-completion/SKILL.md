...
allowed-tools:
  ...
  - Glob
  - Bash
agents: [swe, qa-agent, security, release-agent]
---
...
- Human partner says "I don't believe you" - trust broken
...
## QA Verify: Machine-Readable Proof

Use `qa-verify` to generate a timestamped `QA-RECEIPT.md` before any completion claim.
