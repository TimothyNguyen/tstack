#  migration dotnet sqlserver modernization.Groups[1].Value.ToUpper() igration dotnet sqlserver modernization
...
See [Agent-Architecture](../) for the complete skill catalog.
